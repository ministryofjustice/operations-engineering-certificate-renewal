...
To run the script manually, you can use the following command from the application's root directory:

```source run.sh certexpire```

### Running the Unit Tests

To run the unit test, you can use the following command from the application's root directory:
